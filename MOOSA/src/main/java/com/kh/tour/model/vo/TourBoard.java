...
public class TourBoard {
	...
	public TourBoard(int boardNo, String boardTitle, String boardContent, Date createDate, String userId,
			String categoryName) {
		super();
		this.boardNo = boardNo;
		this.boardTitle = boardTitle;
	...
	public TourBoard(int boardNo, String boardTitle, int count,String boardContent,String thumbnailImg) {
		super();
		this.boardNo = boardNo;
		this.boardTitle = boardTitle;
		this.count = count;
	...
	public TourBoard(String boardTitle, String boardContent, int count, int likes, Date createDate, String userId,
			String categoryName) {
		super();
		this.boardTitle = boardTitle;
		this.boardContent = boardContent;
	...
	public TourBoard(int boardNo, String boardTitle, String boardContent,String boardWriter, Date createDate) {
		super();
		this.boardNo = boardNo;
		this.boardTitle = boardTitle;
		this.boardContent = boardContent;
