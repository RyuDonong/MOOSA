...
public class BoardCategoryController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new BoardService().cListCount(categoryNo);
		...
		// 이전(disabled)  1  2  3  4  5  다음 =>  이전  6  7  다음(disabled)
		...
		ArrayList<Board> list = new BoardService().orderByCategory(categoryNo,bp);
