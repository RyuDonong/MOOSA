										...
										<article class="box post">
											...
											<c:choose>
												<c:when test="${empty list }">
													<div>조회된 위시리스트가 없습니다.</div>
												</c:when>
												<c:otherwise>
													<form action="${contextPath }/deleteWishList.me">
															...
															<c:forEach var ="i" items="${list }">
																...
																<input type="checkbox" name="deleteWishList" value="${i.lodNo }">
																	<article class="style2">
																		...
																		<a href="${contextPath}/lodDetail.lo?lno=${i.lodNo}">
																			<h2 id="wishListTitle">${ i.lodName}</h2>
																			<div class="content">
																				<p>${ i.lodAddress}</p>
																			</div>
																		</a>
