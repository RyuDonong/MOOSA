					...
					<div class="container">
						...
						<div class="row aln-center">
							<div class="col-4 col-5-medium col-12-small">
								...
								<!-- Feature -->
									<section>
										<a href="#1" class="image featured"><img src="images/food/food1.jpg" alt="" /></a>
										<header>
							...
							<div class="col-4 col-5-medium col-12-small">
								...
								<!-- Feature -->
									<section>
										<a href="#2" class="image featured"><img src="images/food/food2.jpg" alt="" /></a>
										<header>
							...
							<div class="col-4 col-5-medium col-12-small">
								...
								<!-- Feature -->
									<section>
										<a href="#" class="image featured"><img src="images/food/food3.jpg" alt="" /></a>
										<header>
							...
							<div class="col-4 col-5-medium col-12-small">
								...
								<!-- Feature -->
									<section>
										<a href="#" class="image featured"><img src="images/food/food4.jpg" alt="" /></a>
										<header>
											<h3>What's this built with?</h3>
										</header>
										<p><strong>Responsive Tools</strong> is a simple set of tools for building responsive
							...
							<div class="col-4 col-5-medium col-12-small">
								...
								<!-- Feature -->
									<section>
										<a href="#" class="image featured"><img src="images/food/food5.jpg" alt="" /></a>
										<header>
											<h3>What's this built with?</h3>
										</header>
										<p><strong>Responsive Tools</strong> is a simple set of tools for building responsive
							...
							<div class="col-4 col-5-medium col-12-small">
								...
								<!-- Feature -->
									<section>
										<a href="#" class="image featured"><img src="images/food/food6.jpg" alt="" /></a>
										<header>
											<h3>What's this built with?</h3>
										</header>
										<p><strong>Responsive Tools</strong> is a simple set of tools for building responsive
								...
								<!-- Feature -->
									<section>
										<a href="#" class="image featured"><img src="images/food/food7.jpg" alt="" /></a>
										<header>
											<h3>Okay, so what is this?</h3>
										</header>
										<p>This is <strong>Strongly Typed</strong>, a free, fully responsive site template
								...
								<!-- Feature -->
									<section>
										<a href="#" class="image featured"><img src="images/food/food8.jpg" alt="" /></a>
										<header>
											<h3>Okay, so what is this?</h3>
										</header>
										<p>This is <strong>Strongly Typed</strong>, a free, fully responsive site template
								...
								<!-- Feature -->
									<section>
										<a href="#" class="image featured"><img src="images/food/food9.jpg" alt="" /></a>
										<header>
											<h3>Okay, so what is this?</h3>
										</header>s
										<p>This is <strong>Strongly Typed</strong>, a free, fully responsive site template
