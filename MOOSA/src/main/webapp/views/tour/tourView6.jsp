					...
					<div class="container">
						...
						<div class="row aln-center">
							<div class="col-4 col-5-medium col-12-small">
								...
								<!-- Feature -->
									<section>
										<a href="#1" class="image featured"><img src="images/activity/activity1.jpg" alt="" /></a>
										<header>
							...
							<div class="col-4 col-5-medium col-12-small">
								...
								<!-- Feature -->
									<section>
										<a href="#2" class="image featured"><img src="images/activity/activity2.jpg" alt="" /></a>
										<header>
							...
							<div class="col-4 col-5-medium col-12-small">
								...
								<!-- Feature -->
									<section>
										<a href="#" class="image featured"><img src="images/activity/activity3.jpg" alt="" /></a>
										<header>
							...
							<div class="col-4 col-5-medium col-12-small">
								...
								<!-- Feature -->
									<section>
										<a href="#" class="image featured"><img src="images/activity/activity4.jpg" alt="" /></a>
										<header>
											<h3>What's this built with?</h3>
										</header>
										<p><strong>Responsive Tools</strong> is a simple set of tools for building responsive
							...
							<div class="col-4 col-5-medium col-12-small">
								...
								<!-- Feature -->
									<section>
										<a href="#" class="image featured"><img src="images/activity/activity5.jpg" alt="" /></a>
										<header>
											<h3>What's this built with?</h3>
										</header>
										<p><strong>Responsive Tools</strong> is a simple set of tools for building responsive
							...
							<div class="col-4 col-5-medium col-12-small">
								...
								<!-- Feature -->
									<section>
										<a href="#" class="image featured"><img src="images/activity/activity6.jpg" alt="" /></a>
										<header>
											<h3>What's this built with?</h3>
										</header>
										<p><strong>Responsive Tools</strong> is a simple set of tools for building responsive
								...
								<!-- Feature -->
									<section>
										<a href="#" class="image featured"><img src="images/activity/activity7.jpg" alt="" /></a>
										<header>
											<h3>Okay, so what is this?</h3>
										</header>
										<p>This is <strong>Strongly Typed</strong>, a free, fully responsive site template
								...
								<!-- Feature -->
									<section>
										<a href="#" class="image featured"><img src="images/activity/activity8.jpg" alt="" /></a>
										<header>
											<h3>Okay, so what is this?</h3>
										</header>
										<p>This is <strong>Strongly Typed</strong>, a free, fully responsive site template
								...
								<!-- Feature -->
									<section>
										<a href="#" class="image featured"><img src="images/activity/activity9.jpg" alt="" /></a>
										<header>
											<h3>Okay, so what is this?</h3>
										</header>s
										<p>This is <strong>Strongly Typed</strong>, a free, fully responsive site template
