					...
					<div class="container">
						...
						<div class="row aln-center">
							<div class="col-4 col-5-medium col-12-small">
								...
								<!-- Feature -->
									<section>
										<a href="#1" class="image featured"><img src="images/art/art1.jpg" alt="" /></a>
										<header>
							...
							<div class="col-4 col-5-medium col-12-small">
								...
								<!-- Feature -->
									<section>
										<a href="#2" class="image featured"><img src="images/art/art2.jpg" alt="" /></a>
										<header>
							...
							<div class="col-4 col-5-medium col-12-small">
								...
								<!-- Feature -->
									<section>
										<a href="#" class="image featured"><img src="images/art/art3.jpg" alt="" /></a>
										<header>
							...
							<div class="col-4 col-5-medium col-12-small">
								...
								<!-- Feature -->
									<section>
										<a href="#" class="image featured"><img src="images/art/art4.jpg" alt="" /></a>
										<header>
											<h3>What's this built with?</h3>
										</header>
										<p><strong>Responsive Tools</strong> is a simple set of tools for building responsive
							...
							<div class="col-4 col-5-medium col-12-small">
								...
								<!-- Feature -->
									<section>
										<a href="#" class="image featured"><img src="images/art/art5.jpg" alt="" /></a>
										<header>
											<h3>What's this built with?</h3>
										</header>
										<p><strong>Responsive Tools</strong> is a simple set of tools for building responsive
							...
							<div class="col-4 col-5-medium col-12-small">
								...
								<!-- Feature -->
									<section>
										<a href="#" class="image featured"><img src="images/beach6.jpg" alt="" /></a>
										<header>
											<h3>What's this built with?</h3>
										</header>
										<p><strong>Responsive Tools</strong> is a simple set of tools for building responsive
								...
								<!-- Feature -->
									<section>
										<a href="#" class="image featured"><img src="images/beach7.jpg" alt="" /></a>
										<header>
											<h3>Okay, so what is this?</h3>
										</header>
										<p>This is <strong>Strongly Typed</strong>, a free, fully responsive site template
								...
								<!-- Feature -->
									<section>
										<a href="#" class="image featured"><img src="images/beach8.jpg" alt="" /></a>
										<header>
											<h3>Okay, so what is this?</h3>
										</header>
										<p>This is <strong>Strongly Typed</strong>, a free, fully responsive site template
								...
								<!-- Feature -->
									<section>
										<a href="#" class="image featured"><img src="images/beach9.jpg" alt="" /></a>
										<header>
											<h3>Okay, so what is this?</h3>
										</header>
										<p>This is <strong>Strongly Typed</strong>, a free, fully responsive site template
